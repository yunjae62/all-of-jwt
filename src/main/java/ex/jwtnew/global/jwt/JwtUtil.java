...
public class JwtUtil {
    ...
    public String createAccessToken(String username, String role) {
        return createToken(username, role, Duration.ofSeconds(ACCESS_TOKEN_TTL_SECONDS).toMillis());
    }
    ...
    public String createRefreshToken(String username, String role) {
        return createToken(username, role, Duration.ofSeconds(REFRESH_TOKEN_TTL_SECONDS).toMillis());
    }
