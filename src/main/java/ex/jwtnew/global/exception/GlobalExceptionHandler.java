package ex.jwtnew.global.exception;

import ex.jwtnew.global.response.CommonEmptyRes;
import ex.jwtnew.global.response.CommonRes;
import ex.jwtnew.global.response.ErrorCase;
import ex.jwtnew.global.response.InvalidInputRes;
...
public class GlobalExceptionHandler {
    ...
    public CommonRes<CommonEmptyRes> handleGlobalException(GlobalException e) {
        ...
        return CommonRes.error(e.getErrorCase()); // 공통 응답 양식 반환
    }
    ...
    public CommonRes<CommonEmptyRes> handleGlobalException(Exception e) {
        ...
        return CommonRes.error(ErrorCase.INVALID_INPUT); // 공통 응답 양식 반환
    }
    ...
    public CommonRes<List<InvalidInputRes>> handlerValidationException(MethodArgumentNotValidException e) {
        ...
        return CommonRes.error(ErrorCase.INVALID_INPUT, invalidInputResList); // 공통 응답 양식 반환
    }
    ...
    public CommonRes<CommonEmptyRes> handleException(Exception e) {
        ...
        return CommonRes.error(ErrorCase.SYSTEM_ERROR); // 공통 응답 양식 반환
    }
}
